...
arrayExemplo.forEach(num => console.log(`${arrayExemplo.indexOf(num)} = ${num}`));
...
const arrayExemplo = [100, 200, 300, 400];
...
executaOperacaoEmArray(arrayExemplo, elemento => elemento + 100);
